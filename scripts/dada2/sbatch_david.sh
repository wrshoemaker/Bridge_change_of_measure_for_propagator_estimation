#!/bin/bash
#SBATCH -J dada2_david
#SBATCH -p normal
#SBATCH -n 1
#SBATCH -c 8
#SBATCH --mem-per-cpu=8G
#SBATCH -t 12:00:00
#SBATCH -o logs/dada2_david.%j.out
#SBATCH -e logs/dada2_david.%j.err
# ---------------------------------------------------------------------------
# DADA2 rerun -- David et al. gut 16S (single-end, truncLen 95)
#
#   mkdir -p logs && sbatch sbatch_david.sh
#
...
STUDY_DIR="$DATA_ROOT/david_et_al"
...
srun --cpu-bind=none Rscript "$PROJECT/scripts/dada2/dada2_david.R"
