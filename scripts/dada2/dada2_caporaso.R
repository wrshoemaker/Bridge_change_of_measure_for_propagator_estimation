#!/usr/bin/env Rscript
# ===========================================================================
# DADA2 -- Caporaso et al. gut 16S  (SINGLE-END, short reads ~150 bp)
#
# Trimming for this study:  truncLen = 120, minLen = 100, no trimLeft
#
# Run via sbatch_caporaso.sh. Configuration comes from environment variables:
