#!/usr/bin/env Rscript
# ===========================================================================
# DADA2 -- Poyet et al. gut 16S  (PAIRED-END, 2 x ~150 bp)
#
# Trimming for this study:  truncLen = c(145, 145), minLen = 120, trimLeft = 5
#
# Run via sbatch_poyet.sh. Configuration comes from environment variables:
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     truncLen = c(145, 145), minLen = 120, trimLeft = 5,
